...
public class FourTabFragment extends Fragment {
    ...
    public static List<ImgJokes> newsDataList_4 = new ArrayList<ImgJokes>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        imgsListViewAdapter = new ImgsListViewAdapter(getContext(), newsDataList_4, R.layout.jokeimgs_list_item);
        fourListView = (ListView) rootView.findViewById(R.id.frame_listview_news_4);
        fourListView.setAdapter(imgsListViewAdapter);
        fourListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Ion.with(img)
                        .fitCenter()
                        .load(newsDataList_4.get(position).getBody());
                dialog.setView(imgEntryView);
                dialog.show();

            }
        });
        fourListView.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
    ...
    public class RequestHistoryGifTask extends AsyncTask<String, Void, JSONObject> {
